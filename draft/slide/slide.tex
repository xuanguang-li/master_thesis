...
\begin{frame}{Baseline result: variance decomposition}
	...
	\hline
	Output & 2.48 & 31.77 & 3.40 & 46.81 & \textbf{19.97} & 1.38 \\ 
	Inflation & 0.32 & 12.21 & 26.73 & 47.43 & 11.13 & 1.62 \\ 
	Interest rate & 0.42 & 18.55 & 14.76 & 48.89 & 14.30 & 4.52 \\ 
	Hours & 3.73 & 49.06 & 1.70 & 14.27 & \textbf{26.52} & 8.24 \\ 
	Investment & 0.45 & 55.80 & 0.26 & 19.66 & \textbf{24.67} & 1.37 \\ 
	...
	{\footnotesize
	Frequency-domain FEVD (\%), business-cycle band \textbf{6--32} quarters. The decomposition is obtained using the spectrum of the DSGE model and an inverse first difference filter for output, consumption abd investment to reconstruct the levels.}
...
\begin{frame}{Takeaway}
	...
	\begin{itemize}
		...
		\item \textbf{Baseline:} 
		\begin{itemize}
			\item The investment demand shock alone explains $\approx 29\%$ of output, $\approx 27\%$ hours worked and $\approx 25\%$ of investment FEVD, which isa competitive driver.
