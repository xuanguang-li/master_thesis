...
\begin{frame}{Motivation}
	...
	\begin{itemize}
		...
		\item \textbf{Nirei and Ragot (2025):} proposed an \emph{investment demand} shock, which \emph{can} generate this comovement, but lacks empirical evidence.
	\end{itemize}
	\vspace{0.5em}
...
\begin{frame}{The estimated DSGE model}
	...
	Based on Smets and Wouters (2007) and Herbst and Schorfheide (2015), augmented with the investment demand shock (explained before).
	\begin{itemize}
...
\begin{frame}{Baseline result: impulse responses}
	...
	\begin{columns}[T,onlytextwidth]
		\column{0.5\textwidth}
		\small\textcolor{accent}{\textbf{IST shock $\Rightarrow$ deflationary}}
		\begin{itemize}\small
