% =====================================================================
% Abstract page of the Master's Thesis (Graduate School of Economics, UTokyo)
% Layout follows the official sample. Compile with XeLaTeX (Japanese title).
%     xelatex abstract_cover.tex   ->   abstract_cover.pdf  (submit as Abstract.pdf)
%
% >>> FILL IN / VERIFY the marked fields below before submission. <<<
% =====================================================================
...
\begin{center}
{\Large Abstract of Master's Thesis}\par
\vspace{0.8cm}
{\large Investment Demand Shock and Business Cycle}\par
\vspace{0.3cm}
{\normalsize 投資需要ショックと景気循環}\par   % <<< VERIFY this translation
\vspace{0.8cm}
\end{center}
\begin{flushright}

Graduate School of Economics\\
Department of Economics (UTIPE)\\
Student ID : 29246603\\          % <<< FILL IN your student ID
Name : LI Xuanguang             % <<< VERIFY your name
